...
var sampleName = 'issue6',
	samplePath = 'magazine/issue6/';
...
function loadPage(page) {
	...
	var img = $('<img />');
	img.load(function() {
		var container = $('.issue6 .p'+page);
		img.css({width: '100%', height: '100%'});
		img.appendTo($('.issue6 .p'+page));
		...
		when: {
			...
			change: function(event, scale) {
				...
				if (scale==1) {
					...
					$('.issue6').removeClass('animated').addClass('zoom-in');
			...
			zoomOut: function () {
				...
				setTimeout(function(){
					$('.issue6').addClass('animated').removeClass('zoom-in');
				}, 0);
