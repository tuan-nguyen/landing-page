...
var sampleName = 'issue9',
	samplePath = 'magazine/issue9/';
...
function loadPage(page) {
	...
	var img = $('<img />');
	img.load(function() {
		var container = $('.issue9 .p'+page);
		img.css({width: '100%', height: '100%'});
		img.appendTo($('.issue9 .p'+page));
		...
		when: {
			...
			change: function(event, scale) {
				...
				if (scale==1) {
					...
					$('.issue9').removeClass('animated').addClass('zoom-in');
			...
			zoomOut: function () {
				...
				setTimeout(function(){
					$('.issue9').addClass('animated').removeClass('zoom-in');
				}, 0);
