...
var sampleName = 'issue4',
	samplePath = 'magazine/issue4/';
...
function loadPage(page) {
	...
	var img = $('<img />');
	img.load(function() {
		var container = $('.issue4 .p'+page);
		img.css({width: '100%', height: '100%'});
		img.appendTo($('.issue4 .p'+page));
		...
		when: {
			...
			change: function(event, scale) {
				...
				if (scale==1) {
					...
					$('.issue4').removeClass('animated').addClass('zoom-in');
			...
			zoomOut: function () {
				...
				setTimeout(function(){
					$('.issue4').addClass('animated').removeClass('zoom-in');
				}, 0);
