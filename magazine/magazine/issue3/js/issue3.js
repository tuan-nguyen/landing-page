...
var sampleName = 'issue3',
	samplePath = 'magazine/issue3/';
...
function loadPage(page) {
	...
	var img = $('<img />');
	img.load(function() {
		var container = $('.issue3 .p'+page);
		img.css({width: '100%', height: '100%'});
		img.appendTo($('.issue3 .p'+page));
		...
		when: {
			...
			change: function(event, scale) {
				...
				if (scale==1) {
					...
					$('.issue3').removeClass('animated').addClass('zoom-in');
			...
			zoomOut: function () {
				...
				setTimeout(function(){
					$('.issue3').addClass('animated').removeClass('zoom-in');
				}, 0);
