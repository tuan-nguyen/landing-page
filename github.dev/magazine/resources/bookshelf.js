...
var currentDemo,
  ...
  samples = {
    'issue1' : {'path' : 'magazine/issue1/'},
    'issue2' : {'path' : 'magazine/issue2/'},
    'issue3' : {'path' : 'magazine/issue3/'},
    'issue4' : {'path' : 'magazine/issue4/'},
    'issue5' : {'path' : 'magazine/issue5/'},
    'issue6' : {'path' : 'magazine/issue6/'},
    'issue7' : {'path' : 'magazine/issue7/'},
    'issue8' : {'path' : 'magazine/issue8/'},
    'issue9' : {'path' : 'magazine/issue9/'},
    'issue10' : {'path' : 'magazine/issue10/'},
    'issue11' : {'path' : 'magazine/issue11/'}
  },
  status = {
    'unloaded' : 0,
    'loading' : 1,
