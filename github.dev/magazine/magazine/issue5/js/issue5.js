...
var sampleName = 'issue5',
	samplePath = 'magazine/issue5/';
...
function loadPage(page) {
	...
	var img = $('<img />');
	img.load(function() {
		var container = $('.issue5 .p'+page);
		img.css({width: '100%', height: '100%'});
		img.appendTo($('.issue5 .p'+page));
		...
		when: {
			...
			change: function(event, scale) {
				...
				if (scale==1) {
					...
					$('.issue5').removeClass('animated').addClass('zoom-in');
			...
			zoomOut: function () {
				...
				setTimeout(function(){
					$('.issue5').addClass('animated').removeClass('zoom-in');
				}, 0);
