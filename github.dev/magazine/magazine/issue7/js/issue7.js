...
var sampleName = 'issue7',
	samplePath = 'magazine/issue7/';
...
function loadPage(page) {
	...
	var img = $('<img />');
	img.load(function() {
		var container = $('.issue7 .p'+page);
		img.css({width: '100%', height: '100%'});
		img.appendTo($('.issue7 .p'+page));
		...
		when: {
			...
			change: function(event, scale) {
				...
				if (scale==1) {
					...
					$('.issue7').removeClass('animated').addClass('zoom-in');
			...
			zoomOut: function () {
				...
				setTimeout(function(){
					$('.issue7').addClass('animated').removeClass('zoom-in');
				}, 0);
